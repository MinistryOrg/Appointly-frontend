  ...
  return (
    <div className="m-unit-xl h-auto w-auto" id="services">
      <div className="w-full ">
        <h1 className="font-bold xsm:text-2xl md:text-4xl text-center">
          Booking made easy
        </h1>
      </div>
      ...
      <div className="lg:mx-auto sm:mx-auto md:my-unit-3xl xsm:mx-auto xsm:my-unit-sm h-full grid gap-x-unit-5xl gap-y-unit-2xl xsm:grid-cols-1 lg:grid-cols-3 justify-center w-fit">
