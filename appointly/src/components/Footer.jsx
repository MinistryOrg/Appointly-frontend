    ...
    <footer className="text-white bg-footerClr px-unit-3xl py-5 w-full h-auto md:px-8 rounded-t-lg">
      <div className="gap-6 justify-between md:flex px-unit-xl my-unit-md">
        <div className="flex-1 ">
          <div className="max-w-xs">
            ...
            <p className="leading-relaxed mt-2 text-[15px] text-white font-semibold">
              Booking made easy!
            </p>
          </div>
        ...
        <div className="flex-1 mt-10 space-y-4 items-center justify-between sm:flex md:space-y-0 md:mt-0">
          {footerNavs.map((item, idx) => (
            <ul className="space-y-4 no-underline" key={idx}>
              <h4 className="text-white font-medium">{item.label}</h4>
              {item.items.map((el, idx) => (
                <li key={idx}>
                  <a href={el.href} className="hover:text-slate-300">
                    {el.name}
                  </a>
                </li>
              ))}
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex px-8">
        <div className="mt-4 sm:mt-0">
          &copy; 2023-2028 Apointly All rights reserved. MinistryOrg ©.
        </div>
        <div className="mt-6 sm:mt-0">
          <div className="flex items-center gap-x-6 text-white mt-6">
            <a href="/#">
              <svg
                className="w-6 h-6 hover:text-slate-400 duration-150"
                fill="none"
                viewBox="0 0 48 48"
              >
                <g clip-path="url(#a)">
